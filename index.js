    ...
    function main() {
        ...
        function BuildMenuEntry(name, info, id, configpane, override, element) { //Creates tickbox element with info and optional (new) config pane (see guesspractice). in a pane
            ...
            if (configpane != undefined) { //If any configpane was passed through try and create a button to open it.
              ...
              window.configbutton.style.color = "#033dff"
                /* OG color 
window.configbutton.style.color = "#f9a619" */
      ...
      window.copyright = document.createElement("p")
       /*   let copyrightbuild = document.createElement("button")
          copyrightbuild.innerHTML="Credits"          copyrightbuild.setAttribute("onclick","Copyrightdisp()");*/

         /* function Copyrightdisp(){
            alert("EdgenTweaks Version 5.0.1 by mrnukeOT assistant DEV litong cracked by mrnukeOT original by Gradyn Wursten. This is free and unencumbered software released into the public domain. Anyone is free to copy, modify, publish, use, compile, sell, or distribute this software, either in source code form or as a compiled binary, for any purpose, commercial or non-commercial.");
          }*/
        window.copyright.innerHTML = "EdgenTweaks Version 5.0.1 by mrnukeOT assistant DEV litong cracked by mrnukeOT original by Gradyn Wursten. This is free and unencumbered software released into the public domain. <br> Anyone is free to copy, modify, publish, use, compile, sell, or distribute this software, either in source code form or as a compiled binary, for any purpose, commercial or non-commercial." 
/* (<a href='https://github.com/Syphon1205/EdgenHacks-EdgenTweaks/issues'>Report a bug!</a>)   (<a href='https://github.com/Syphon1205/EdgenHacks-EdgenTweaks'>Github</a>) <br> */
